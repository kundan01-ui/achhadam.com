        ...
        <div className="text-center">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
            ...
            <div className="space-y-3 text-left">
              {getFeatures().map((feature, index) => (<div key={index} className="flex items-center space-x-2">
            ...
            <div className="mt-6">
              <button onClick={onLogout} className="w-full bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition-colors">
                {t('logout')}
              </button>
            </div>
          </div>
